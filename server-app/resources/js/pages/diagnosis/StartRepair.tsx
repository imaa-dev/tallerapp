...
import type { StartRepairProps } from '@/types';
...
export default function StartRepair({ servi, approve_url }: StartRepairProps) {
    return (
        <>
            <Head title="Aprobación de inicio de reparación" />
            ...
            <div className="flex min-h-screen flex-col items-center bg-gray-100 p-4 dark:bg-gray-900 sm:p-8">
                <div className="w-full max-w-2xl rounded-xl bg-white p-6 shadow-lg dark:bg-gray-800 sm:p-8">
                    ...
                    <Section title="Inicio de reparación">
                        <p className="text-sm text-gray-900 dark:text-gray-100">
                            Su producto ha sido recibido en el taller y está listo para comenzar la revisión y
                            reparación. Para iniciar, necesitamos su aprobación. Al aprobar, el servicio pasará a
